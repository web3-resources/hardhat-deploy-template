...
interface AvalancheFriendsCollectibleInterface extends ethers.utils.Interface {
  functions: {
...
export class AvalancheFriendsCollectible extends Contract {
  ...
  interface: AvalancheFriendsCollectibleInterface;
